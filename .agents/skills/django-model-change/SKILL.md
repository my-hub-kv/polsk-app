...
4. Create schema migrations with `python manage.py makemigrations`; never hand-write them. Do not modify existing data migrations—create a new reviewed migration instead. Prefer constraints and nullable historical references where appropriate; add migration/model tests and inspect generated operations when risk warrants.
