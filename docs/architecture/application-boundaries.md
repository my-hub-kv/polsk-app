...
**Architecture status: Candidate structure.** The modular-monolith decision is accepted, but these proposed Django app boundaries must not be scaffolded until a feature needs them.
