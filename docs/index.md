...
- **Development:** [setup](development/setup.md), [Python and Django standards](development/coding-standards.md), [commenting](development/commenting-and-code-documentation.md), [testing](development/testing.md), [migrations](development/migrations.md), [security](development/security.md), and [pull requests](development/pull-request-process.md).
